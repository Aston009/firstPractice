window.addEventListener('DOMContentLoaded', () => {
    ...
    let form = document.querySelector('.main-form'),
        ...
        formCall = document.getElementById('form'),
        inputCall = formCall.getElementsByTagName('input');
    ...
    formCall.addEventListener('submit', function(event) {
        ...
        let obj = {}; // Ошибка, не заполняется объект
        formData.forEach(function(value, key) {
            console.log('hi');
            obj[key] = value;
        });
        ...
        request.addEventListener('readystatechange', function() {
            ...
            for(let i = 0; i < inputCall.length ; i++) {
                inputCall[i].value = '';
            }        
    ...
    let persons = document.querySelectorAll('.counter-block-input')[0],
        resDays = document.querySelectorAll('.counter-block-input')[1],
